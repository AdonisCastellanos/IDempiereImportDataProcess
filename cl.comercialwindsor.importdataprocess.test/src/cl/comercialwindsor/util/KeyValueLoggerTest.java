 ...
 *
 * Copyright (C) 2022 Windsor and contributors (see README.md file).
 */

package cl.comercialwindsor.util;

import static cl.comercialwindsor.test.util.RandomTestUtil.*;
import static cl.comercialwindsor.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"cl.comercialwindsor.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"cl.comercialwindsor.util\"");
	}

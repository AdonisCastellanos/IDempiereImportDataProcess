# Windsor-ImportDataProcess

## Standard

- New callout
    * Name: CName
    * Package: cl.comercialwindsor.callout
    * Example: cl.comercialwindsor.callout.CStringFormat

- New process
    * Name: PName
    * Package: cl.comercialwindsor.process
    * Example: cl.comercialwindsor.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: cl.comercialwindsor.form
    * Example: cl.comercialwindsor.form.FMultiPayment

- New event
    * Name: EName
    * Package: cl.comercialwindsor.event
    * Example: cl.comercialwindsor.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: cl.comercialwindsor.model
    * Example: cl.comercialwindsor.model.MTableExample

## Folder estructure

```
    cl.comercialwindsor.importdataprocess
        |_.settings
...
- New callout
    * Create callout in package `cl.comercialwindsor.callout`, extends from `CustomCallout`
    * Register callout in `cl.comercialwindsor.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `cl.comercialwindsor.process`, extends from `CustomProcess`
    * Register process in `cl.comercialwindsor.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `cl.comercialwindsor.form`, extends from `CustomForm`
    * Register form in `cl.comercialwindsor.component.FormFactory`. Example:
...
- New event
    * Create event in package `cl.comercialwindsor.event`, extends from `CustomEvent`
    * Register event in `cl.comercialwindsor.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `cl.comercialwindsor.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `cl.comercialwindsor.component.ModelFactory`. Example:
